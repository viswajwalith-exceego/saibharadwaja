<%@ Page Title="" Language="C#" MasterPageFile="~/sbjsm.master" AutoEventWireup="true" CodeFile="acharyaeb.aspx.cs" Inherits="pages_acharyaeb" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphSbChildPageContent" runat="Server">
    ...
    <div class="container-fluid  bg-transparant  p-sm-2  p-md-5 pt-md-0"><%--Padding Div1--%>
        <div class="container-fluid  bg-transparant p-1 p-md-5"> <%--Padding Div2--%>
            ...
            <div class="accordion accordion-flush " id="accordionFlusA1"> <%--Accordian Flush Start--%>
                <div class="accordion-item"> <%--Accordian Item--%>
                    ...
                    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlusA1"> <%--Accordian Collapse Body--%>
