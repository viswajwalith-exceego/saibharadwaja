<%@ Page Title="" Language="C#" MasterPageFile="~/sbjsm.master" AutoEventWireup="true" CodeFile="acharyaebbs.aspx.cs" Inherits="pages_acharyaebbs" %>
...
<div class="theChildPageContentOffsetter">
    <div class="container bg-transparant d-flex justify-content-center ">
        <div class="row">
            <div class="col">
                <span class="PageHeadingBS1">Parama Pujya Acharya Sri Ekkirala Bharadwaja</span>
            </div>
        </div>
    </div>


    <div class="container-fluid  bg-transparant  p-sm-2 p-md-5"><%--Padding Div1--%>
        <div class="container-fluid  bg-transparant p-1 p-md-5"> <%--Padding Div2--%>
                        
            <div class="accordion accordion-flush " id="accordionFlusA1"> <%--Accordian Flush Start--%>
                <div class="accordion-item"> <%--Accordian Item--%>
                    ...
                    <div id="flush-collapseOne" class="accordion-collapse collapse show" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlusA1"> <%--Accordian Collapse Body--%>
                        <div class="accordion-body"><%--Accordian Item Body--%>
                            

                            <div class="container bg-light d-flex justify-content-center">
                                <asp:Image ID="imgat1" runat="server" ImageAlign="Middle" ImageUrl="~/images/MasterEB/mastermain2.gif" />
                                <br />
                            </div>
                            <div>
                             ...
                             <span class="txtInitialLetterHigh">I</span>t is no exaggeration to say that  <b>Pujya Acharya Ekkirala Bharadwaja, who is fondly called as ‘Master’ is known to every Sai devotee.</b>
	                                ...
	                                In his quest for Truth, <b>he analysed modern science and proved the existence of God in a scientific manner </b>and thus became a bacon of light to the students of the present day and to the very system of education. His works in Telugu viz. "Edi Nijam" (What is reality?), "Matham Enduku?" ("Why Religion"), Vignana Veechikalu ("Waves of Scientific Knowledge") amply prove that the moral and spiritual values can be imparted to the youth even through Scientific Education of today.
                        <br>
                                    <br>
                        ...
                        </div> <%--Accordian Item Body--%>
                     </div> <%--Accordian Collapse Body--%>
                </div><%--Accordian Item--%>
               ...
               <div class="accordion-item"> <%--Accordian Item--%>
                    ...
                    <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlusA1"> <%--Accordian Collapse Body--%>
                        <div class="accordion-body  bg-transparant"><%--Accordian Item Body--%>
                                                   ...
                                                   'Matrusri'   Alivelumangamma lovingly called as 'Ammagaru' is born in Mannava 
                                                    ...
                                                    <img class="img-fluid float-start  p-3" src="../images/MasterEB/ammagarumastergaru2.gif" alt="" />
                                                    <p class="textJustified">    
                                                    ...
                                                    <p class="textJustified">With the initiative of Brahmachari Ramachandra (a beloved devotee of 
                                                    Mastergaru), a Monstery at Gaangaapuram and Sri Alivelumanga Sahita Bharadwaja 
                                                    Ashram at Shirid are under development.</p>
                                                    ...
                                                    <p class="textJustified">This is the special occassion for all of us to feel the presence and 
                                                    knowledge of the great, her holiness 'Divyajanani' Alivelumangamma on her 60th 
                                                    Birthday on October 1st, 2005.</p>
                                                    <p class="textJustified"><font color="green"><b>May all of us get special blessings on the day.</b></font></p>
                                                    <p class="textJustified">A quote from a revered devotee of Sri Gajana Maharaj says, <br />
                                                    "We salute the very dust particles on the Feet of saints. Liberation does not 
               ...
               <div class="accordion-item"> <%--Accordian Item--%>
                    ...
                    <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlusA1"> <%--Accordian Collapse Body--%>
                        <div class="accordion-body"><%--Accordian Item Body--%>
                   ...
                   <div class="accordion-item"> <%--Accordian Item--%>
                    ...
                    <div id="flush-collapseFour" class="accordion-collapse collapse" aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlusA1"> <%--Accordian Collapse Body--%>
                        <div class="accordion-body"><%--Accordian Item Body--%>
   ...
   <thead>
    ...
    <tbody>
    <tr>
      <td><a href="http://www.saibharadwaja.org/books/readbook.aspx?book=Bhagavan-Sri-Bharadwaja" target="_blank" class="textDarkBlueLink">భగవాన్ శ్రీ భరద్వాజ</a></td>
    ...
    <tr>
      <td><a href="http://www.saibharadwaja.org/books/readbook.aspx?book=Mahapurushudu" target="_blank" class="textDarkBlueLink" >మహా పురుషుడు</a></td>
    ...
    <tr>
      <td><a href="http://www.saibharadwaja.org/books/readbook.aspx?book=Mahatmula-Muddu-Biddadu" class="textDarkBlueLink"  target="_blank">మహాత్ముల ముద్దుబిడ్దడు</a></span></td>      
